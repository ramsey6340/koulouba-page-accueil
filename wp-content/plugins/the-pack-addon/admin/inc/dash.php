...
class The_Pack_Demo_Sites_Dash {
	...
	public function display_import_page() {
		...
		foreach($paged_products as $demo) { 
			...
			$btn = $demo['pro'] && !class_exists('The_Pack_Pro') ? __('Purchase','the-pack') : __('Import','the-pack');
		...
		<?php if ( !wp_doing_ajax() ) { echo '<div class="xlimwrap">'; } ?>
			...
			<div class="header">
				<div class="lhead">
					<h2 class="lib-logo"><?php echo __('Sites','the-pack').'<span>'.$total_products.'</span>';?></h2>
				</div>

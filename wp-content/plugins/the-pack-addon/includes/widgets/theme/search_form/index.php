...
class thepack_search_widget extends Widget_Base
{
    ...
    {
        return esc_html__('Search Form', 'thepack');
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Search form', 'thepack')
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'no_button' => [
                        'title' => esc_html__('No button', 'thepack'),
                        'icon' => 'fa fa-folder',
                    ],
                    'ikn_button' => [
                        'title' => esc_html__('Icon button', 'thepack'),
                        'icon' => 'fa fa-folder-o',
                    ],
                    'txt_button' => [
                        'title' => esc_html__('Text button', 'thepack'),
        ...
        $this->add_control(
            'txt_color',
            [
                'label' => esc_html__('Input color', 'thepack'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'bg_color',
            [
                'label' => esc_html__('Input background', 'thepack'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_btnikn',
            [
                'label' => esc_html__('Icon Button', 'thepack'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'tmpl!' => 'no_button',
                ],
